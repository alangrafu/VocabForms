...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/../../../uploaded/files/',
            'upload_url' => $this->getFullUrl().'/uploaded/files/',
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/../../../uploaded/thumbnails/',
